...
In cases where the project is not able to process JS assets, there are pre-processed assets available for use. See -- `auro-layover__bundled.js` for modern browsers. Legacy browsers such as IE11 are no longer supported.
...
<script src="https://cdn.jsdelivr.net/npm/@aurodesignsystem/auro-layover@0.0.0/dist/auro-layover__bundled.js" type="module"></script>
```
...
Automated tests are required for every Auro component. See `.\test\auro-layover.test.js` for the tests for this component. Run `npm test` to run the tests and check code coverage. Tests must pass and meet a certain coverage threshold to commit. See [the testing documentation](https://auro.alaskaair.com/support/tests) for more details.
